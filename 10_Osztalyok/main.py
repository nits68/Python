...
# A jellemzők speciális kódtagok, gyakran egy privát mező írását és olvasását felügyelik
...
class Homerseklet:  # a class foglalt szó után adjuk meg az osztály azonosítóját (nevét)
    ...
    feldolgozas_alatt: bool  # publikus mező, osztálypéldány felől is elérhető

    def __init__(self, ertek_fok: float = 0) -> None:
        self.ertekfok = ertek_fok
        self.feldolgozas_alatt = False

    def valtoztat(self, delta_fok: float) -> None:
        self._ertekfok += delta_fok
    ...
    @property
    def ertekfok(self) -> float:  # írható / olvasható jellemző
...
# print(testho._ertekfok)  # Pylance figyelmeztetés: "_ertekfok" is protected and used outside of the class in which it is declaredPylance (reportPrivateUsage)

print(testho.ertekfok)  # jellemző olvasása
testho.ertekfok = 36.4  # jellemző írása
print(testho.ertekfahrenheit)  # jellemző olvasása
# testho.ertekfahrenheit = 100  # Cannot assign member "ertekfahrenheit" for type "Homerseklet"  Property "ertekfahrenheit" has no defined setterPylance

try:
    proba: Homerseklet = Homerseklet(-300)  # osztálypéldány (objektum) létrehozása
except Exception as ex:
    print(f'Hiba doc: {ex.__doc__}')
