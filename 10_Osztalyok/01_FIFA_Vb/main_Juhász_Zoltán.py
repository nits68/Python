class Csapat:
  def __init__(self, sor):
    ...
    self.elsoOtaElteltEv = 2021 - self.elsoIndulas
...
for i in range(1, len(csapatok)):
  if csapatok[i].elsoIndulas < csapatok[mini].elsoIndulas: mini = i
...
while i < len(csapatok):
  if csapatok[i].orszag == "Magyarország":
    ...
    else: print("Magyarország nem jutott ki az első VBre")
    break
  i += 1
else: print("Magyarország sosem jutott ki VB-re")
